// Updated from project_v4.c where I added memory allocation so that I am able to run with bigger n.
// However, I need to improve the running time in which use and not recompute visiting permutation.
...
bool allocate_memory(int n)
{
    ...
    printf("Total memory: %.2f MB\n", (2.0 * FACT * sizeof(int)) / (1024.0 * 1024.0));
